...
| continuous/experiencelog | PID_experiencelog_yyyymmdd.csv | Custom made questionnaire about experiences wearing the light glasses. Completed any time participant had an experience to report (no restrictions). | Empty folder for PID 210 and 225 |
